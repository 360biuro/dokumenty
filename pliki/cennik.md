...
| ----- | :---: | :---: | ----- |
| Stały koszt infrastrukturalny (m-c) | 50 | m-c | Opłata obejmuje utrzymanie środowiska kadrowo-płacowego, systemów oraz podstawowej obsługi techniczno-administracyjnej, niezależnie od liczby pracowników lub umów. |
...
| Składnik | Stawka | Jednostka | Opis |
| ----- | :---: | :---: | ----- |
| Prowadzenie akt osobowych | 30 | pracownik/m-c | Usługowe prowadzenie teczek osobowych, tzw. ABC dla pracowników zgodnie z ustawą |
| Kontrola terminów: badania lekarskie, BHP, ważność dokumentów itp. | 30 | pracownik/m-c | Usługowe prowadzenie rejestru terminów pracowniczych. |
| Obsługa zajęcia komorniczego | 90 | zajęcie/m-c | Sporządzanie pism do komorników, naliczanie potrąceń, rozliczanie sald związanych z zajęciami komorniczymi. |
| PIT-11 / PIT-4R (szt.) | 50 | szt. | Sporządzenie/wysłanie drogą elektroniczną deklaracji podatkowej |
